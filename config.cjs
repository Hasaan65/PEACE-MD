...
const config = {
  SESSION_ID: process.env.SESSION_ID || "PEACE~dFRiiSoA#hXDb5qeVpobIDMdzCN7-8UXcBw9I_Jn-aabGeyDBIQ4",
  PREFIX: process.env.PREFIX || '.',
  BOT_NAME: process.env.BOT_NAME || "PEACE-MD",
  BOT: process.env.BOT || "hello 👋",
  NEW_CMD: process.env.NEW_CMD || "ᴀᴅᴅᴠᴀʀ\n│ sᴜᴅᴏ\n| peace",
  CAPTION: process.env.CAPTION || "POWERED BY HASAAN",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by HASAAN',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "❁ ════ ❃• Hasaan •❃ ═",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923126675673",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "923126675673",
